...
export default function Practice() {
  ...
  const {
    questions, currentIndex, answers, results, isWrongPractice,
    selectAnswer, toggleAnswer, submitAnswer, nextQuestion, prevQuestion, goToQuestion,
    isFinished, getStats, startPractice,
  } = usePracticeStore()
  ...
  const handleSelect = (answer: OptionKey) => {
    if (currentQuestion.type === 'multiple') {
      toggleAnswer(currentQuestion.id, answer)
    } else {
